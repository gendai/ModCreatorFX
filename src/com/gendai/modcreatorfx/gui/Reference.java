...
/**
 * The class containing the different needed files location.
 * @author gendai
 * @version 0.0.1
 */
public class Reference {
	public static final String OUTPUT_LOCATION = "./javaoutput/";
	public static final String CONFIG_LOCATION = "./javaoutput/config/";
